...
export function IconStar({ size = 20, filled = false, className }: IconProps & { filled?: boolean }) {
  return (
...
export function IconAttend({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M18 11V6a2 2 0 00-2-2 2 2 0 00-2 2v0" />
      <path d="M14 10.5V4a2 2 0 00-2-2 2 2 0 00-2 2v0" />
